...
COPY target/appassembler/repo/vtl-spark/*/vtl-spark-*.jar /vtl-spark.jar
COPY target/appassembler/repo/vtl-model/*/vtl-model-*.jar /vtl-model.jar
COPY target/appassembler/repo/vtl-engine/*/vtl-engine-*.jar /vtl-engine.jar
COPY target/appassembler/repo/vtl-parser/*/vtl-parser-*.jar /vtl-parser.jar
